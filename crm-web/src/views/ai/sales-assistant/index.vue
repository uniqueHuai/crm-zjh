    ...
    <main class="chat-main">
      ...
      <template v-if="!currentConvId && messages.length === 0">
        <div class="welcome">
          ...
          <h2>销售助手</h2>
          <p class="welcome-desc">智能分析客户数据、追踪销售业绩、挖掘商机</p>
          <div class="suggestions">
            <div class="suggestion-card" @click="quickAsk('汇总我本月的销售业绩')">
              <el-icon><TrendCharts /></el-icon>
              <span>汇总本月销售业绩</span>
            </div>
            <div class="suggestion-card" @click="quickAsk('我有哪些待跟进的客户？')">
              <el-icon><User /></el-icon>
              <span>待跟进客户列表</span>
            </div>
            <div class="suggestion-card" @click="quickAsk('分析上周的商机转化情况')">
              <el-icon><DataAnalysis /></el-icon>
              <span>商机转化分析</span>
            </div>
            <div class="suggestion-card" @click="quickAsk('哪些产品销量最好？')">
      ...
      <template v-else>
        <div class="chat-header">
          <div class="chat-header-info">
            <span class="chat-agent-name">销售助手</span>
        ...
        <div class="messages-container" ref="messagesRef">
          ...
          >
            ...
            <div class="msg-body">
              <div class="msg-sender">{{ msg.role === 'assistant' ? '销售助手' : '你' }}</div>
          ...
          <div v-if="messages.length > 3" class="scroll-hint" ref="scrollHintRef">
            <el-button text size="small" @click="scrollToBottom">滚动到底部</el-button>
          </div>
        </div>
      </template>
...
.chat-sidebar {
  ...
  .conversation-item {
    ...
    &.active {
      ...
      .conv-title { color: $primary; font-weight: 600; }
    }
    .conv-icon {
...
.welcome {
  ...
  .suggestion-card {
    ...
    &:hover {
      ...
      box-shadow: 0 2px 8px rgba($primary, 0.06);
    }
...
.input-area {
  ...
  &.input-welcome {
    border-top: none;
    background: linear-gradient(180deg, transparent, rgba($bg, 0.5));
  }
