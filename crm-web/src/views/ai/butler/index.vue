  ...
  <div class="chat-container">
    ...
    <div class="chat-main">
      <div class="messages-container" ref="messagesRef">
        ...
        >
          <div class="avatar">
            <el-icon v-if="msg.role === 'assistant'" :size="20"><DataAnalysis /></el-icon>
        ...
        <div v-if="loading" class="message-row assistant">
          <div class="avatar"><el-icon :size="20"><DataAnalysis /></el-icon></div>
      ...
      <div class="input-area">
        <el-input
          ...
          type="textarea"
          :rows="3"
          placeholder="输入你的问题，例如：公司本季度的销售情况如何？"
          :disabled="loading"
...
.chat-sidebar {
  ...
  .conversation-list { flex: 1; overflow-y: auto; padding: var(--crm-space-sm); }
  .conversation-item {
...
.messages-container { flex: 1; overflow-y: auto; padding: var(--crm-space-lg); }
...
.message-row {
  ...
  &.user {
    ...
    .message-content { background: var(--crm-primary); color: #fff; border-radius: 12px 4px 12px 12px; }
  }
  &.assistant {
    .avatar { background: #f0f0f0; color: var(--crm-text-regular); }
    .message-content { background: var(--crm-bg-gray); border-radius: 4px 12px 12px 12px; }
  }
}
...
.message-content {
  ...
  :deep(pre) { background: #1e1e1e; color: #d4d4d4; padding: 12px; border-radius: 8px; overflow-x: auto; font-size: 13px; margin: 8px 0; }
...
.input-area {
  padding: var(--crm-space-lg); border-top: 1px solid var(--crm-border); background: #fff;
  .input-actions {
